"""Regression checks for the parity-sec-token-lens casebook."""
...
from casebook.harness import assert_expected, parity_sec_token_lens_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(parity_sec_token_lens_summary(), assert_expected())
