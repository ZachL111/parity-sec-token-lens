...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-parity-sec-token-detail.ps1

php tests/test_domain_review.php

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-parity-sec-token-properties.ps1
