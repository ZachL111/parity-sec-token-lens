...
$repo = "parity-sec-token-lens"
$language = "PHP"
$category = "Security tooling"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/parity-sec-token-walkthrough.md")) {
